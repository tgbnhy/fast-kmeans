...
public class Process {
	...
	public static ArrayList<Point> INSTANCES = new ArrayList<Point>();
	static ArrayList<ClusteringCenter> PRE_CENS;
	public static int DIMENSION;
	public static int MAX_INSTANCE_NUM_NOT_SPLIT = Integer.valueOf(LoadProperties.load("max_instances_num_not_split"));
